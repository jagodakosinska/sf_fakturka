...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Invoice::class, mappedBy="vendor", orphanRemoval=true)
     */
    private $invoices;

    /**
     * @ORM\OneToMany(targetEntity=Customer::class, mappedBy="vendor", orphanRemoval=true)
     */
    private $customers;

    /**
     * @ORM\OneToMany(targetEntity=Item::class, mappedBy="vendor", orphanRemoval=true)
     */
    private $items;
